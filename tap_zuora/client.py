...
class Client:
    def __init__(self, username, password, partner_id, sandbox=False, european=False, oauth=False):
    ...
    def from_config(config):
        ...
        oauth = config.get('oauth', False) == 'true'
        return Client(config['username'], config['password'], partner_id, sandbox, european, oauth)
